...
TEST(test_tree_delete_root_1, "Delete a root node (H), tree should be empty")
bst_init(&test_tree);
bst_insert(&test_tree, 'H', 1);
bst_print_tree(test_tree);
...
TEST(test_tree_insert_root_1, "Delete a right subtree on the left subtree xD (node A)")
bst_init(&test_tree);
bst_insert(&test_tree, 'H', 10);
bst_insert(&test_tree, 'A', 11);
bst_insert(&test_tree, 'B', 15);
bst_print_tree(test_tree);
bst_delete(&test_tree, 'A');
bst_print_tree(test_tree);
ENDTEST

TEST(test_tree_insert_root_1_5, "Delete a right subtree on the left subtree xD")
bst_init(&test_tree);
bst_insert(&test_tree, 'H', 10);
bst_insert(&test_tree, 'L', 11);
bst_insert(&test_tree, 'J', 15);
bst_print_tree(test_tree);
bst_delete(&test_tree, 'L');
bst_print_tree(test_tree);
ENDTEST

TEST(test_tree_insert_root_2, "Delete a right subtree on the left subtree xD")
bst_init(&test_tree);
bst_insert(&test_tree, 'H', 10);
bst_insert(&test_tree, 'L', 11);
bst_insert(&test_tree, 'U', 12);
bst_print_tree(test_tree);
bst_delete(&test_tree, 'H');
bst_print_tree(test_tree);
ENDTEST

TEST(test_tree_insert_root_3, "Delete a right subtree on the left subtree xD")
bst_init(&test_tree);
bst_insert(&test_tree, 'H', 10);
bst_insert(&test_tree, 'D', 11);
bst_insert(&test_tree, 'B', 12);
bst_insert(&test_tree, 'E', 12);
bst_print_tree(test_tree);
bst_delete(&test_tree, 'H');
bst_print_tree(test_tree);
ENDTEST
...
TEST(test_tree_delete_both_subtrees_parent, "Delete a node with both subtrees while moving a parent (F, H)")
bst_init(&test_tree);
bst_insert_many(&test_tree, base_keys, base_values, base_data_count);
...
int main(int argc, char *argv[]) {
  ...
  test_tree_delete_root_1();
  test_tree_insert_root_1();
  test_tree_insert_root_1_5();
  test_tree_insert_root_2();
  test_tree_insert_root_3();
